...
Исходная иерархия внутри ветки сохранена. Перенесено 417 файлов:
...
Курированные наборы `reference_kits/` не тронуты: там фон намеренно лежит в
одной папке с образцом, парой на геометрию.
