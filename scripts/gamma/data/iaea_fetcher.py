...
detector-specific Lsrm library. Users invoke it explicitly when
...
DEFAULT_CACHE_DIR = Path("references/iaea_cache")
...
def fetch_iaea_gamma_lines(
    ...
    *,
    ...
    req = urllib.request.Request(
        url, headers={"User-Agent": "spectravibe/1.7 (scientific use)"},
    )
    ...
    # `audit/_drafts/_ollama_helpers/_vram_guard.py` ticket files.
